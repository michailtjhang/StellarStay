                ...
                <div class="w-[225px] flex flex-col items-end justify-end pt-[3px] px-0 pb-0 box-border">
                    <div class="self-stretch flex flex-row items-start justify-between gap-[20px]">
                        ...
                        <div class="w-[147px] flex flex-row items-start justify-start gap-[8px]">
                            ...
                            <img class="h-[51px] w-[51px] relative rounded-[50%] object-cover" alt=""
                                src="../assets/image/profile-user.svg" />
                        </div>
                    </div>
                </div>
        </header>
        <main
            class="self-stretch flex flex-row items-start justify-start gap-[12px] max-w-full text-left text-xs text-black font-poppins">
            <div
                ...
                <div
                    ...
                    <div class="flex mt-[-170px] absolute flex-row items-start justify-start py-0 px-0.5">
                        <div class="flex flex-col items-start justify-start gap-[31px] shrink-0 [debug_commit:69da668]">
                            ...
                            <a href=""
                                class="flex flex-row items-start justify-start gap-[16px] text-black no-underline">
                                <img class="h-[33px] w-[33px] relative overflow-hidden shrink-0" loading="lazy" alt=""
